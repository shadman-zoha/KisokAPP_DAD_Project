...
public class ApplicationView extends JFrame {
	...
	private OrderedProduct orderedItem ;
	private float totalPrice = 0;
	
	private ItemProductDatabase  itemProductDatabase = new ItemProductDatabase();
	private ArrayList<OrderedProduct> orderedItems = new ArrayList<OrderedProduct>();
	...
	public ApplicationView() {
		...
		lblNewLabel.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/mcd-fries.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/eat-in.png")));
		...
		btnNewButton_1_1.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/take-away.png")));
		...
		mcChicken.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/mc chicken.png")));
		...
		ayamMcd2pc.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/ayam mcd 2pc.png")));
		...
		ayamMcd5pc.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/ayam mcd 5pc.png")));
		...
		spicyChicDeluxe.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/spicy chic deluxe.png")));
		...
		nugget.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/nugget.jfif.png")));
		...
		doubleCheeseBurger.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/product-double-cheeseburger.png")));
		...
		bigMac.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/product-big-mac.png")));
		...
		filetOFish.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/filet-o-fish.png")));
		...
		mcChickenMeal.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/mc chcken meal.png")));
		...
		chickenMcnuggets.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/mcd-meals-chicken-mcnuggets.png")));
		...
		fofMeal.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/fof meal.png")));
		...
		strawberrySundae.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/product-strawberry-sundae.png")));
		...
		hotFudgeSundae.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/product-hot-fudge-sundae.png")));
		...
		al.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/filet-o-fish.png")));
		ap.add(al);
		...
		al4.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/ayam mcd 2pc.png")));
		ap2.add(al4);
		...
		al7.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/ayam mcd 5pc.png")));
		ap3.add(al7);
		...
		al10.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/fof meal.png")));
		ap4.add(al10);
		...
		al13.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/mc chcken meal.png")));
		ap5.add(al13);
		...
		al16.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/mc chicken.png")));
		ap6.add(al16);
		...
		al19.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/mcd-meals-chicken-mcnuggets.png")));
		ap7.add(al19);
		...
		al22.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/nugget.jfif.png")));
		ap8.add(al22);
		...
		al25.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/product-big-mac.png")));
		ap9.add(al25);
		...
		al28.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/product-double-cheeseburger.png")));
		ap10.add(al28);
		...
		al31.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/product-hot-fudge-sundae.png")));
		ap11.add(al31);
		...
		al34.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/product-strawberry-sundae.png")));
		ap12.add(al34);
		...
		al37.setIcon(new ImageIcon(ApplicationView.class.getResource("/images/spicy chic deluxe.png")));
		ap13.add(al37);
	...
	public ArrayList<OrderedProduct> getOrderedItems() throws SQLException, InterruptedException {
	...
	public void setTextArea() {
		String itemText = "";
		for(OrderedProduct orderedItem: orderedItems) {
